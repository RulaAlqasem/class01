...
class Main extends React.Component {
    ...
    constructor(props) {
        super(props);
      r.push( arrayEl.map( element =>{ return this.setState.state = {
        name: element.title,
    ...
    render() {
        ...
        function returnMe() {
             ...
             for (let i = 0; i <r.length; i++) {
              console.log( < HornedBeasts  name={ r[i].state.name} description={r[i].state.description} imgUrl={r[i].state.image_url} />);
            } 
